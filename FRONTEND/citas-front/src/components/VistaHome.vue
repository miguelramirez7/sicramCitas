<template>
    <div class="imagen">
        <v-app-bar color="" dense dark absolute>
            <v-app-bar-nav-icon @click="drawer = !drawer" class="mostrarEnPantallaPequeña"></v-app-bar-nav-icon>
        ...
        <div class="d-flex flex-column align-center justify-center principal">
            <div class="contenedor">
                <h1 class="titulo  font-weight-black mb-5 text-center white--text d-flex align-center">BIENVENIDO A
                    SICRAM</h1>
                <h2 class="grey--text mb-5 subtitulo">Consultorio de citas médicas</h2>
                <v-btn class="mx-2" dark large color="cyan" elevation="10">
                    <v-icon left>
                        accessibility
                    </v-icon>
                    COMENZAR
...
<style scoped>
    .imagen {
        ...
        position: relative;
        object-fit: cover;
        background-image: linear-gradient(to right, rgba(5, 12, 31, 0.493), rgba(5, 12, 31, 0.493)),
